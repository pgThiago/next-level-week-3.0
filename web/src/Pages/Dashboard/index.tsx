...
const Dashboard: React.FC = () => {
  return (
    ...
    <div className="container">
      ...
      <aside>
        <img src={mapMarker}   alt="map-marker"  id="map-marker" />
        <img src={mapPin}      alt="map-pin"     id="map-pin" />
        <img src={alertCircle} alt="alert-circle"id="alert-circle" />
        <img src={logOut}      alt="log-out"     id="log-out" />
      </aside>
